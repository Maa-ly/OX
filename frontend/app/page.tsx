...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/90 drop-shadow-md sm:text-xl">
                Transform your anime and manga engagement into tradable assets. Own your data, 
                contribute to your favorite IPs, and profit from the cultural value you create.
              </p>
      ...
      <section className="py-24 sm:py-32 relative z-20 bg-[#0a0a0f]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-base font-semibold uppercase tracking-wide text-cyan-400">The Concept</h2>
            <p className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              Stock Market for Fandom Engagement
            </p>
            <p className="mt-6 text-lg leading-8 text-zinc-400">
              Think of ODX as a stock market, but instead of trading company shares, you trade tokens 
              that represent the engagement and popularity of anime, manga, and manhwa IPs.
            </p>
          </div>
          ...
          <div className="mx-auto mt-20 grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/50 to-zinc-900/30 p-8 transition-all hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-white">Data is the Commodity</h3>
                <p className="mt-3 text-zinc-400">
                  Your engagement data—ratings, predictions, memes, reviews—becomes a valuable, 
                  tradable asset stored on decentralized Walrus storage.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/50 to-zinc-900/30 p-8 transition-all hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-white">Fans Own the Data</h3>
                <p className="mt-3 text-zinc-400">
                  Every contribution is cryptographically signed with your wallet, proving ownership 
                  and ensuring you control your engagement data.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/50 to-zinc-900/30 p-8 transition-all hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10">
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold text-white">Contributors Get Rewarded</h3>
                <p className="mt-3 text-zinc-400">
                  Early contributors and accurate predictors earn tokens from the reserve pool, 
                  proportional to their impact on IP popularity.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="border-t border-zinc-800 bg-zinc-950/50 py-24 sm:py-32 relative z-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-base font-semibold uppercase tracking-wide text-cyan-400">How It Works</h2>
            <p className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              ...
              {[
                {
                  ...
                  description: 'Rate anime, make predictions, post memes, or leave reviews. Each contribution is signed with your wallet and stored on Walrus decentralized storage.',
                },
                {
                  number: '02',
                  title: 'Data Aggregation & Metrics',
                  description: 'The oracle service aggregates all contributions, verifies signatures, and calculates engagement metrics that feed into token price calculations.',
                },
                {
                  number: '03',
                  title: 'Token Value Reflects Engagement',
                  description: 'As engagement grows—higher ratings, accurate predictions, viral content—the IP token price increases, reflecting the cultural value you helped create.',
                },
                {
                  number: '04',
                  title: 'Trade & Profit',
                  description: 'Buy and sell IP tokens on the marketplace, trade perpetual futures, and earn rewards as an early contributor or accurate predictor.',
                },
              ].map((step, index) => (
                <div key={index} className="relative flex gap-8">
                  ...
                  <div className="flex-1 pb-12">
                    ...
                    <p className="mt-3 text-lg leading-7 text-zinc-400">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* Features */}
      <section id="features" className="py-24 sm:py-32 relative z-20 bg-[#0a0a0f]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-base font-semibold uppercase tracking-wide text-cyan-400">Key Features</h2>
            <p className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              Everything You Need
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Your engagement data is cryptographically signed and stored on Walrus, giving you complete ownership and control.',
                icon: (
              ...
              },
              {
                ...
                description: 'Track who contributed what and earn tokens for early engagement and accurate predictions.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              },
              {
                ...
                description: 'Buy and sell IP tokens like stocks, trade perpetual futures, and profit from engagement trends.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              {
                title: 'Transparency',
                description: 'All data is stored on decentralized Walrus, with public analytics and verifiable engagement metrics.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
      ...
      <section className="border-t border-zinc-800 bg-gradient-to-br from-zinc-950 to-zinc-900 py-24 sm:py-32 relative z-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
            Join ODX and turn your passion for anime and manga into a valuable asset. 
            Your engagement data is worth something—own it.
          </p>
